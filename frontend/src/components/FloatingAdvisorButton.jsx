    ...
    <>
      {!open && (
        <button
          ...
          className="fixed bottom-6 right-6 z-[60] group flex items-center gap-4 pl-5 pr-7 py-4.5 bg-vermillion text-oat font-heading text-sm uppercase tracking-[0.14em] shadow-[8px_8px_0_0_#0A0A0A] hover:shadow-[10px_10px_0_0_#0A0A0A] hover:-translate-y-0.5 transition-all"
