      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-10 py-12 md:py-16 grid grid-cols-12 gap-6 relative">
        <div className="col-span-12 lg:col-span-7">
          ...
          <p className="mt-4 font-body text-sm text-oat/70 leading-relaxed max-w-xl">
            85 pages. Feature → Benefit → Feeling framework. 15 copy-paste AI prompts. 5-part MLS template. Real before/after rewrites. Read it in one sitting — use it on your next listing the same day.
          </p>
